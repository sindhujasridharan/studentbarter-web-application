	...
	<div class="main-content transdiv">
		<form method="POST" action="">
			...
			<table class="mytable table-striped" border="1">
				...
				<tbody>
					<c:forEach items="${websitefeedbacks}" var="websitefeedback">
						<tr>
							<td>${websitefeedback.fullName}</td>
							<td>${websitefeedback.userEmail}</td>
							<td>${websitefeedback.feedbackMessage}</td>
							<td>${websitefeedback.givenOn}</td>
						</tr>
					</c:forEach>
				</tbody>
			</table>
