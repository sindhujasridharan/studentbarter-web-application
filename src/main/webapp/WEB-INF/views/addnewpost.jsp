...
<body>
	...
	<div class="main-content">
		<form:form method="POST" modelAttribute="addNewPostForm">
			<h4 class="center-align">Add New Post</h4>
					...
					<div class="col-md-12 line-spacer">
						...
						<div class="col-md-8">
							<form:input type="text" path="title" class="form-control"
								placeholder="Post Title" autofocus="true" required="true"></form:input>
					...
					<div class="col-md-12 line-spacer">
						...
						<div class="col-md-8">
							<form:input type="text" path="description" class="form-control"
								placeholder="Description of the Post" required="true"></form:input>
			...
			<spring:bind path="itemworth">
				<div class="form-group ${status.error ? 'has-error' : ''}">
					<div class="col-md-12 line-spacer">
						...
						<div class="col-md-8">
							<form:input type="number" path="itemworth" class="form-control"
								placeholder="Cost" required="true"></form:input>
			...
			<div class="col-md-12 line-spacer">
				...
				<div class="col-md-6">
					<select id="itemcategoryfornewpost" name="itemcategoryfornewpost">
						<c:forEach items="${itemcategoriesnewpost}"
